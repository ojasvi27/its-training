...
<title> ITS | Corporate training company in gurgaon</title>
	...
	<form method="POST" name="customerData" action="ccavRequestHandler.php">
		<input type="text" name="redirect_url" value="http://www.itstraining.in/ccavResponseHandler.php"/>
		<input type="text" name="cancel_url" value="http://www.itstraining.in/ccavResponseHandler.php"/>
		<input type="text" name="currency" value="INR"/>

		<input type="text" name="merchant_id" value="57422" readonly="true " />
		...
		<table class="table table-bordered"	>
			...
			<table class="table table-bordered">
		        ...
		        <tr> <th> Data Accepted At </th>
		         ...
		         <tr> <th> Issuing Bank:</th>
		            <th><input type="text" name="issuing_bank" value="" class="form-control"/>e.g. State Bank Of India</th>
		         </tr>
			 <tr> 
				<th> Mobile Number:</th>
		            	<th><input type="text" name="mobile_number" class="form-control" value=""/>e.g. 9770707070</th>
		         </tr>
			<tr> 
				<th> MMID:</th>
