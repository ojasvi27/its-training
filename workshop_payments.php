...
<title> ITS | Corporate training company in gurgaon</title>
		...
		<script src="http://itstraining.in/js/jquery.js"></script>

		<script src="http://itstraining.in/js/jquery.validate.js"></script>
	...
	<body>
		...
		<div class="container">
	<?php $api_obj ->getpaymentDetailsForWorkshop($_GET['id']);?>
