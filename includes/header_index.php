  ...
  <div class="container nav_white"> 
    ...
    <div class="navbar navbar-default yamm">
      <div class="navbar-header">
        ...
        <a href="http://itstraining.in/index.php" class="navbar-brand"><img src="http://itstraining.in/images/logo_new.png" width="100" /></a> </div>
        ...
        <ul class="nav navbar-nav navbar-right pagescroll-menu">
          ...
          <!--With Offsets 
              ...
              <li><a href="#rooms_scroll" class="page-scroll" > Training Rooms </a>
           </li>
          
            <li><a class="page-scroll"  href="workshops.php" >Training Calendar</a></li>

            <li><a class="page-scroll"  href="feedback.php" >Feedback</a></li>
            <li>
            ...
            <li><a class="page-scroll"  href="jobs.php" >Jobs</a></li>
          ...
          <li>   <span href="javascript:void(0)"   class="btn btn-danger btn-sm online_assment red-btn" onclick="window.open('attempt_online_test.php ', 'child', 'width=1900,height=1900,left=0,top=0,scrollbars=yes')" >Online Assessment</span>
         </li>
        </ul>
      </div>
    </div>
